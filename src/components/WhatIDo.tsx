        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building intelligent AI solutions, neural networks, and automation systems.
              </p>
          ...
          >
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>ANDROID & ROBOTICS</h3>
              <h4>Description</h4>
              <p>
                Creating Android apps and intelligent robotics systems with automation.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">ESP32-CAM</div>
                <div className="what-tags">OpenCV</div>
                <div className="what-tags">IoT/MQTT</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
